 ...
 * </p>
 * <ul>
 *   <li><b>Livello di Presentazione</b>: Interfaccia utente a console (package {@code com.library.ui})</li>
 *   <li><b>Livello di Business Logic</b>: Servizi che implementano la logica di business (package {@code com.library.service})</li>
 *   <li><b>Livello di Accesso ai Dati</b>: Repository per la persistenza dei dati (package {@code com.library.repository})</li>
 *   <li><b>Livello di Modello</b>: Classi che rappresentano le entità del dominio (package {@code com.library.model})</li>
 * </ul>
 * 
 ...
 * <p>
 * Implementato attraverso la gerarchia di eccezioni personalizzate nel package {@code com.library.exception}.
...
public class ArchitectureDoc {
    ...
    public static final String PRESENTATION_LAYER = "com.library.ui";
    public static final String BUSINESS_LOGIC_LAYER = "com.library.service";
    public static final String DATA_ACCESS_LAYER = "com.library.repository";
    public static final String MODEL_LAYER = "com.library.model";
    ...
    public static final String EXCEPTION_SHIELDING = "com.library.exception";
